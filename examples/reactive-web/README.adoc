...
----
include::{manualIncludeDir}examples/reactive-web/src/main/java/org/neo4j/doc/driver/springframework/boot/web/DisplayMoviesController.java[tags=reactive-web-example,indent=0]
----
