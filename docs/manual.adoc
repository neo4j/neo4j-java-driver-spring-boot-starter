...
* [ ] _You have the previous generation of Spring Data Neo4j or Neo4j-OGM?_
  You cannot use this starter, as Spring Data Neo4j + OGM is based on the previous generation of the Java driver.
...
The Spring Initializr will take care of creating a valid project structure for your,
...
include::configuraton-options.adoc[]
